...
class dbbox extends StatefulWidget {
  const dbbox({super.key});

  @override
  State<dbbox> createState() => _dbboxState();
}

class _dbboxState extends State<dbbox> {
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 16.0),
                                    child: Text(
                                      "Complete code for the Frame 4 in figma file and show it to Ashish bhaiya '${display_list[index].organisationName}'",
                                      style: GoogleFonts.inter(
                                          textStyle: TextStyle(
                                              color: Gcolors.primaryColor050,
                                              fontSize: 14,
